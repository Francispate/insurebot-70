...
(function () {
  ...
  function buildWidget() {
    ...
    launcher.setAttribute("aria-label", "Open InsureBot chat");
    launcher.innerHTML = `
      ...
      <div class="chat-header">
        <div class="chat-header-info">
          ...
          <div>
            ...
            <div class="chat-subtitle">AI Insurance Assistant</div>
          </div>
        </div>
  ...
  function renderInputArea() {
    ...
    area.innerHTML = `
      <textarea id="chat-input" class="chat-textarea"
                ...
                placeholder="Ask about your policy or claim…"></textarea>
